...
====================
Provides an official Government Open Data (OGD) integration
for fetching APMC Mandi prices without web scraping.

This file was extracted from agmarknet.py to keep file sizes
small and maintain separation of concerns.
"""
