"""Connector for NaPanta mandi pages."""
...
class NaPantaConnector(BaseRateConnector):
    """Scrape NaPanta as a validator source."""

    source_id = "napanta"
    rate_kind = RateKind.MANDI_WHOLESALE
    authority_tier = AuthorityTier.VALIDATOR
    ttl_minutes = 360
    source_url = "https://www.napanta.com/market-price/karnataka"
