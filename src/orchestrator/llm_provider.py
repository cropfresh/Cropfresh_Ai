...
# * ═══════════════════════════════════════════════════════════════
# * STANDARD MESSAGE / RESPONSE MODELS
# * ═══════════════════════════════════════════════════════════════
...
class BedrockProvider(BaseLLMProvider):
    ...
    ! SECURITY: AWS credentials are read from environment / IAM role.
    ! Never pass credentials directly — use AWS_PROFILE, IAM roles, or env vars.
    """

    # ! Bedrock inference profile IDs for on-demand usage.
    # ! APAC profiles route to ap-south-1; global profiles route anywhere.
