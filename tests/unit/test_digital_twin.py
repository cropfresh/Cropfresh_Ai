...
# * ═══════════════════════════════════════════════════════════════
# * QualityAssessmentAgent Twin Integration Tests
# * ═══════════════════════════════════════════════════════════════
...
class TestQualityAgentTwinIntegration:
    ...
    async def test_compare_twin_via_agent(self, qa_agent: QualityAssessmentAgent):
        ...
        # Arrange: create twin in agent's engine first
        qr = QualityResult(
    ...
    @pytest.mark.asyncio
    async def test_compare_twin_unknown_id_raises(self, qa_agent: QualityAssessmentAgent):
